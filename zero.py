...
import os,time,colorama,subprocess,json,urllib.request,requests,urllib.request,sys,json,socket
...
{Fore.RED}
{Fore.RED}    ▒███████▒▓█████{Fore.WHITE}  ██▀███   ▒█████  
{Fore.RED}    ▒ ▒ ▒ ▄▀░▓█   ▀{Fore.WHITE} ▓██ ▒ ██▒▒██▒  ██▒ ᶻᴱᴿᴼ {Fore.RED}ᶠᴿᴬᴹᴱᵂᴼᴿᴷ {Fore.RESET} 
{Fore.RED}    ░ ▒ ▄▀▒░ ▒███  {Fore.WHITE} ▓██ ░▄█ ▒▒██░  ██▒   {Fore.RED}-{Fore.RESET} ᴸᴼᴿᴰ⁴ᵀᴮ
{Fore.RED}      ▄▀▒   ░▒▓█  ▄{Fore.WHITE} ▒██▀▀█▄  ▒██   ██░
{Fore.RED}    ▒███████▒░▒████{Fore.WHITE}▒░██▓ ▒██▒░ ████▓▒░
{Fore.RED}    ░▒▒ ▓░▒░▒░░ ▒░ {Fore.WHITE}░░ ▒▓ ░▒▓░░ ▒░▒░▒░ 
{Fore.RED}    ░░▒ ▒ ░ ▒ ░ ░  {Fore.WHITE}░  ░▒ ░ ▒░  ░ ▒ ▒░ 
...
def bannerIP():
    print(f"""
{Fore.CYAN}    ________     ___       __    __                       _       ____    
{Fore.CYAN}   /  _/ __ \   /   | ____/ /___/ /_______  __________   (_)___  / __/___ 
{Fore.CYAN}   / // /_/ /  / /| |/ __  / __  / ___/ _ \/ ___/ ___/  / / __ \/ /_/ __ \  ᶻᴱᴿᴼ {Fore.CYAN}ᶠᴿᴬᴹᴱᵂᴼᴿᴷ {Fore.RESET} 
{Fore.CYAN} _/ // ____/  / ___ / /_/ / /_/ / /  /  __(__  |__  )  / / / / / __/ /_/ / {Fore.CYAN}-{Fore.RESET} ᴸᴼᴿᴰ⁴ᵀᴮ
{Fore.CYAN}/___/_/      /_/  |_\__,_/\__,_/_/   \___/____/____/  /_/_/ /_/_/  \____/ 
{Fore.RESET}""")

def bannerWEB():
    print(f"""{Fore.LIGHTMAGENTA_EX}                                                                                                                                                                                                  
    // | |                                                                                    
   //__| |     ___   /  _   __     ( )   __          ___      ___       __      ___     //    
  / ___  |   //   ) / // ) )  ) ) / / //   ) )     //   ) ) //   ) ) //   ) ) //___) ) //     
 //    | |  //   / / // / /  / / / / //   / /     //___/ / //   / / //   / / //       //      
//     | | ((___/ / // / /  / / / / //   / /     //       ((___( ( //   / / ((____   //       
                                                                                             {Fore.RESET}ᶻᴱᴿᴼ {Fore.LIGHTMAGENTA_EX}ᶠᴿᴬᴹᴱᵂᴼᴿᴷ {Fore.RESET}  
{Fore.LIGHTMAGENTA_EX}          //  ) )                                                                               {Fore.LIGHTMAGENTA_EX}-{Fore.RESET} ᴸᴼᴿᴰ⁴ᵀᴮ
{Fore.LIGHTMAGENTA_EX}       __//__  ( )   __      ___   /  ___      __                                               
{Fore.LIGHTMAGENTA_EX}        //    / / //   ) ) //   ) / //___) ) //  ) )                                            
{Fore.LIGHTMAGENTA_EX}       //    / / //   / / //   / / //       //                                                  
{Fore.LIGHTMAGENTA_EX}     //    / / //   / / ((___/ / ((____   //                                                   
{Fore.RESET}""")

def bannerPOR():
    print(F"""{Fore.LIGHTGREEN_EX}
d ss.    sSSSs   d ss.  sss sssss        sss.   sSSs. d s.   d s  b 
S    b  S     S  S    b     S          d       S      S  ~O  S  S S 
S    P S       S S    P     S          Y      S       S   `b S   SS 
S sS'  S       S S sS'      S            ss.  S       S sSSO S    S 
S      S       S S   S      S               b S       S    O S    S 
S       S     S  S    S     S               P  S      S    O S    S 
P        "sss"   P    P     P          ` ss'    "sss' P    P P    P 
...
{Fore.RESET}""")
print(F"""[ {Fore.RED}1{Fore.RESET} ] IP Address info
[ {Fore.RED}2{Fore.RESET} ] Admin panel finder
[ {Fore.RED}3{Fore.RESET} ] Port Scan
[ {Fore.RED}H{Fore.RESET} ] Help
""")

loo = input(Fore.RED+f"root@kali{Fore.RESET}:{Fore.RED}~{Fore.RESET}# ")
if loo == '1':
    os.system('clear')
    bannerIP()
    print(F"[ {Fore.CYAN}*{Fore.RESET} ] Enter IP Address \n")
    ippp = input(Fore.CYAN+f"root@kali{Fore.RESET}:{Fore.CYAN}~{Fore.RESET}# ")
    print(F"[ {Fore.CYAN}*{Fore.RESET} ] Processing ...")
    time.sleep(1.5)

    url = ("http://ip-api.com/json/")
    response = urllib.request.urlopen(url + ippp)
    data = response.read()
    jso = json.loads(data)
    time.sleep(0.5)
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Url : " + ippp + "")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] IP: " + jso["query"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Status: " + jso["status"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Region: " + jso["regionName"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Country: " + jso["country"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] City: " + jso["city"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] ISP: " + jso["isp"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Lat & Lon: " + str(jso['lat']) + " & " + str(jso['lon']) + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Zipcode: " + jso["zip"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] TimeZone: " + jso["timezone"] + "\033[0m")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] AS: " + jso["as"] + "\033[0m" + "\n")
    print(f"[ {Fore.CYAN}*{Fore.RESET} ] Whois Lookup IP")
    print(" ")
    command = ("whois " + ippp)
    proces = os.popen(command)
    results = str(proces.read())
    print("\033[0m" + results + "\033[0m")
    input(f'[ {Fore.CYAN}*{Fore.RESET} ] Press enter to exit ...')
    exit()
if loo == '2':
    os.system('clear')
    bannerWEB()
    print(F"[ {Fore.LIGHTMAGENTA_EX}*{Fore.RESET} ] Enter website url {Fore.LIGHTMAGENTA_EX}( {Fore.RESET}https://www.lord4tb.cf {Fore.LIGHTMAGENTA_EX}or{Fore.RESET} http://www.lord4tb.cf {Fore.LIGHTMAGENTA_EX}){Fore.RESET} \n")
    url = input(Fore.LIGHTMAGENTA_EX+f"root@kali{Fore.RESET}:{Fore.LIGHTMAGENTA_EX}~{Fore.RESET}# ")
    print(F"[ {Fore.LIGHTMAGENTA_EX}*{Fore.RESET} ] Processing ...")
    time.sleep(1.5)
    page = ('admin/','administrator/','wp-login.php','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
    ...
    for page2 in page :
        ...
        try :
            ...
            openurl = urllib.request.urlopen(url1)

            
            print(f"[ {Fore.LIGHTMAGENTA_EX}+{Fore.RESET} ] Admin panel found >> "+url1)


        except urllib.error.URLError as msg :
            
            print (f"[ {Fore.RED}X{Fore.RESET} ] Admin panel not found >> "+url1)
...
if loo == '3':
    ...
    os.system('clear')
    bannerPOR()
    print(F"[ {Fore.LIGHTGREEN_EX}*{Fore.RESET} ] Enter IP Address \n")
    ia = input(Fore.LIGHTGREEN_EX+f"root@kali{Fore.RESET}:{Fore.LIGHTGREEN_EX}~{Fore.RESET}# ")
    print(F"[ {Fore.LIGHTGREEN_EX}*{Fore.RESET} ] Processing ...")
    time.sleep(1.5)
    for p1 in ports:
        we = socket.socket(socket.AF_INET,socket.SOCK_STREAM)
        c = we.connect_ex((ia,p1))
        svc = ports[p1]
        if c == 0:
            time.sleep(2)
            print("""
...
if loo == 'h':
    ...
    bannerHELP()
    #by lord4tb
    print(F"""[ {Fore.LIGHTYELLOW_EX}1{Fore.RESET} ] About me  
[ {Fore.LIGHTYELLOW_EX}2{Fore.RESET} ] v2 Coming soon  
[ {Fore.LIGHTYELLOW_EX}3{Fore.RESET} ] Update 
    
    """)
        #by lord4tb

    abb = input(Fore.LIGHTYELLOW_EX+f"root@kali{Fore.RESET}:{Fore.LIGHTYELLOW_EX}~{Fore.RESET}# ")
    if abb == '1':
        os.system('clear')
        bannerHELP()
        print('Zero tool v1')
        print("Developed by LOR4TB, @ilord4tb")
        input(f'[ {Fore.LIGHTYELLOW_EX}*{Fore.RESET} ] Press enter to exit ...')
        exit()
    if abb == '2':
        os.system('clear')
        bannerHELP()
